...
@Component({
  selector: 'app-tab-details-show',
  templateUrl: './tab-details-show.component.html',
  styleUrls: ['./tab-details-show.component.css']
})
export class TabDetailsShowComponent implements OnInit {
